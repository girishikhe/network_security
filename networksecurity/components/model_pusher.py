...
from networksecurity.cloud_storage.aws_storage import SimpleStorageService
...
from networksecurity.entity.s3_estimator import Network_Estimator
...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        self.network_estimator = Network_Estimator(bucket_name=model_pusher_config.bucket_name,
